...
/**
 * List of official IANA-registered mime types.
 *
 * @privateRemarks
 * Generated from https://www.iana.org/assignments/media-types/media-types.xhtml with:
 * ```js
 * [
 *   ...document.querySelectorAll("#table-application > tbody:nth-child(2) > tr > td:nth-child(2)")
 * ].map(el=>'"'+el.textContent.trim()+'"').join('|')
 * ```
 */
export type OfficialMimeTypes =
